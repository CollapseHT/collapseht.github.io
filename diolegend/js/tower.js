...
function handleButtonClick(event) {
    ...
    if (isgo == 0 && start_x >= 500 && start_x <= 700 && start_y >= 300 && start_y <= 500) {
        ...
        talkimg.addEventListener("load", (e) => {
            talk(100, 200, '劇情1：亞納提斯王國國內一直都是和平繁榮的國家，直到索默帝國的到來一直在侵犯亞納提斯王國，迪歐和一些軍官們徹退到一處易守難攻的城堡，迪歐的部隊準備跟帝國軍死戰。(本關為森林，敵方弓兵出線機率小幅提升)', '遊玩方法及規則：用滑鼠點擊出兵鈕進行攻打，打爆敵方主堡即可獲勝，反之自己主堡爆了就失敗。');
...
function esends(x) {
    ...
    } else if (echance > 0.3 && echance <= 0.6) {
